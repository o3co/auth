...
# also lists create-app and tests/*, which are not copied: they are just not
# workspace projects here. Both installs are --frozen-lockfile, which accepts
# that and refuses any other departure from the lockfile.
